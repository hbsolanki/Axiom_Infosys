      ...
      <div className="">
        ...
        >
          <div className="px-5 md:px-10">
            <h1 className="text-5xl md:text-6xl font-serif tracking-wider">
              Axiom Infosys
            </h1>
            <p className="mt-6 text-base md:text-lg leading-relaxed tracking-wide">
              We are Sales and Service Providers of all <b>Laptops</b>,{" "}
              <b>Desktops</b>,<b> CCTV Cameras</b>, <b>Printers</b> and{" "}
              <b>All Computer/Laptop Accessories</b>.<br />
            ...
            <a
              ...
              className="inline-block mt-8 px-6 py-2 text-black bg-orange-500 rounded-lg text-lg font-medium hover:bg-white transition-colors"
            >
              CONTACT US
            </a>
          </div>
