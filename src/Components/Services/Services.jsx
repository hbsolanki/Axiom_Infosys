...
const Service = () => {
  return (
    <>
      <section className="pt-8 lg:pt-12 dark:bg-dark">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-base text-body-color dark:text-dark-6 mt-2">
              Sales & Service Provider of Laptops, Desktop PCs, CCTV Cameras,
              and Printers.
            </p>
          </div>
          ...
          <div className="flex flex-wrap -mx-4">
            <ServiceCard
              title="Desktop PC"
              details="PC problem? We’ll solve it. We’re who you call when your desktop runs slow and your programs stop working. We also sell refurbished PCs and systems."
              icon={DesktopPc}
            />
            <ServiceCard
              title="Laptops"
...
const ServiceCard = ({ icon, title, details }) => {
  return (
    <div className="w-full px-4 mb-8 md:w-1/2 lg:w-1/3">
      <div className="bg-white dark:bg-dark-2 rounded-lg shadow-lg hover:shadow-xl transition-shadow p-6">
        <img
          className="mb-6 h-40 w-full object-cover rounded-lg"
          src={icon}
          alt={title}
        />
        <h4 className="text-xl font-semibold text-dark dark:text-black mb-2">
          {title}
        </h4>
