...
export default function Footer() {
  return (
    <footer className="relative w-full  bg-black text-white p-6">
      <div className="mx-auto w-full max-w-7xl px-8">
        <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
          <Typography variant="h5" className=" text-4xl ">
            <p className="mb-5 nerko-one-regular">Axiom Infosys</p>
            <div className="">
              <iframe
          ...
          <div className="grid grid-cols-3 justify-between gap-4">
            ...
            <Typography>
              <div className="row-end-1 grid-cols-4">
                <h6 className=" flex items-center justify-center uppercase md:justify-start mb-3 font-medium opacity-40">
                  <svg
